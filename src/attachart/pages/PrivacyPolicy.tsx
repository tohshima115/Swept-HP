...
const PrivacyPolicy = () => {
  return (
    <Container maxWidth="md" sx={{ py: 4, color: 'var(--color-on-surface)' }}>
      ...
      <Typography>最終更新日: 2025年6月21日</Typography>
      ...
      <Box sx={{ my: 4 }}>
        ...
        <Typography>
          Swept株式会社（以下「当社」といいます。）は、当社が提供する愛着スタイル診断サービス（以下「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます。）を定めます。
        </Typography>
      </Box>
